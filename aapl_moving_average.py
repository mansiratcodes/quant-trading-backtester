...
print("--- Step 3 (Adjusted): Running 50-Day Backtest Simulation ---")
...
# 2. NEW MATH: Calculate the 50-day moving average (longer, smoother anchor)
data['50_Day_Mean'] = data['Close'].rolling(window=50).mean()

# 3. Create signals based on the new 50-day rule
data['Signal'] = 0
...
# 6. Multiply all daily returns together to get the grand total growth
